...
/**
* Fait changer de direction le pakuman automatiquement
* @param pc Un pointeur sur Le pakuman
* @param map La map
*/
void pakumanChangeDirectionAI(character *pc,int map[MAP_HEIGHT_MAX][MAP_WIDTH_MAX]);
/**
* Modifie les coordonnées et la direction du pakuman en fonction d'une intelligence artificielle
* @param pc Un pointeur vers le pakuman
* @param map La carte du jeu
* @param screenWidth  La largeur de l'écran
* @param screenHeight La hauteur de l'écran
*/
void pakumanMoveAI(character *pc, int map[MAP_HEIGHT_MAX][MAP_WIDTH_MAX], int screenWidth, int screenHeight);
/**
